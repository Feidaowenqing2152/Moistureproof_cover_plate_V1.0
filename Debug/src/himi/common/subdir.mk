...
C_SRCS += \
../src/himi/common/hmi_common.c 

C_DEPS += \
./src/himi/common/hmi_common.d 

OBJS += \
./src/himi/common/hmi_common.o 


# Each subdirectory must supply rules for building sources it contributes
src/himi/common/%.o: ../src/himi/common/%.c src/himi/common/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-himi-2f-common

clean-src-2f-himi-2f-common:
	-$(RM) ./src/himi/common/hmi_common.d ./src/himi/common/hmi_common.o

.PHONY: clean-src-2f-himi-2f-common
