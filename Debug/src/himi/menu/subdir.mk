...
C_SRCS += \
../src/himi/menu/menu.c 

C_DEPS += \
./src/himi/menu/menu.d 

OBJS += \
./src/himi/menu/menu.o 


# Each subdirectory must supply rules for building sources it contributes
src/himi/menu/%.o: ../src/himi/menu/%.c src/himi/menu/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-himi-2f-menu

clean-src-2f-himi-2f-menu:
	-$(RM) ./src/himi/menu/menu.d ./src/himi/menu/menu.o

.PHONY: clean-src-2f-himi-2f-menu
